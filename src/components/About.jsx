        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="mt-12">
                ...
                <div className="space-y-6">
                  <div className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-[2px] before:bg-gradient-to-b before:from-blue-600 before:to-blue-300">
                    <div className="absolute left-[-8px] top-1 w-4 h-4 rounded-full bg-blue-600"></div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="group col-span-2">
              <div className="p-8 bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                <Terminal
            ...
            <div className="group">
              <div className="h-full p-8 bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                <Trophy
                  className="text-blue-600 mb-4 group-hover:animate-pulse"
                  size={36}
                />
